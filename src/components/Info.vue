          ...
          >
            ...
            <tfoot>
              <tr>
                ...
                <td
                  class="pb-0 pl-8 pr-0 pt-6 text-right tabular-nums text-gray-900"
                >
                  {{ invoice.subTotal }}
                </td>
              </tr>
              <tr>
                <th
                  scope="row"
                  class="pt-4 font-normal text-gray-700 sm:hidden"
                >
                  Tax
                </th>
                <th
                ...
                <td
                  class="pb-0 pl-8 pr-0 pt-4 text-right tabular-nums text-gray-900"
                >
                  {{ invoice.tax }}
                </td>
              </tr>
              <tr>
                ...
                <td
                  class="pb-0 pl-8 pr-0 pt-4 text-right font-semibold tabular-nums text-gray-900"
                >
                  {{ invoice.total }}
                </td>
              </tr>
